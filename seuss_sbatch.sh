...
python main.py --save-dir results/Acrobot-v1_epsgreedy_best_param_100000_rp --agent-json config/agent/epsgreedy_best_param.json --env-json config/environment/Acrobot-v1.json --index 5 &
python main.py --save-dir results/Acrobot-v1_epsgreedy_best_param_100000_rp --agent-json config/agent/epsgreedy_best_param.json --env-json config/environment/Acrobot-v1.json --index 6 &
python main.py --save-dir results/Acrobot-v1_epsgreedy_best_param_100000_rp --agent-json config/agent/epsgreedy_best_param.json --env-json config/environment/Acrobot-v1.json --index 7 &
python main.py --save-dir results/Acrobot-v1_epsgreedy_best_param_100000_rp --agent-json config/agent/epsgreedy_best_param.json --env-json config/environment/Acrobot-v1.json --index 8 &
python main.py --save-dir results/Acrobot-v1_epsgreedy_best_param_100000_rp --agent-json config/agent/epsgreedy_best_param.json --env-json config/environment/Acrobot-v1.json --index 9 
