...
python main.py --save-dir results/jan5/eps-greedy-best-hypers-wexploration --agent-json config/agent/epsgreedy_best_acrobot.json --env-json config/environment/Acrobot-v1.json --index 0 &
python main.py --save-dir results/jan5/eps-greedy-best-hypers-wexploration --agent-json config/agent/epsgreedy_best_acrobot.json --env-json config/environment/Acrobot-v1.json --index 1 &
python main.py --save-dir results/jan5/eps-greedy-best-hypers-wexploration --agent-json config/agent/epsgreedy_best_acrobot.json --env-json config/environment/Acrobot-v1.json --index 2 &
python main.py --save-dir results/jan5/eps-greedy-best-hypers-wexploration --agent-json config/agent/epsgreedy_best_acrobot.json --env-json config/environment/Acrobot-v1.json --index 3 &
python main.py --save-dir results/jan5/eps-greedy-best-hypers-wexploration --agent-json config/agent/epsgreedy_best_acrobot.json --env-json config/environment/Acrobot-v1.json --index 4 
...
# python main.py --save-dir results/jan5/eps-greedy-uniform-exploration-sweep --agent-json config/agent/epsgreedy_classic_sweep.json --env-json config/environment/Acrobot-v1_dense.json --index 7 &
